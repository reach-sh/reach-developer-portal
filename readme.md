...
<span style="color:red;">Important: Once a user expands or collapses the OTP column, the application remembers that state, and applies it to every page that the user visits.</span>
